...
<div class="container" id="container">
	<div class="form-container sign-up-container">
      ...
      <input type="password" name="password" placeholder="Password" />
			<input type="text" name="buyer_budget" placeholder="Budget" />
...
if (isset($_POST['login'])) {
    ...
    */ 
    ...
    $sql = "SELECT * FROM user WHERE username='$username' AND password='$password' AND status='buyer'";
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        header("Location: index.php?page=buyer-page");
    } else {
    ...
    */
    ...
    $name = $_POST['name'];
    $email = $_POST['email'];
    $buyer_budget = $_POST['buyer_budget'];
    ...
    if (mysqli_num_rows($result) > 0) {
      ...
      $sql = "INSERT INTO user (username, email, password, status) VALUES ('$username', '$email', '$password', 'buyer')";
      $result = mysqli_query($conn, $sql);
      ...
      $sql = "INSERT INTO buyer (userID, buyer_name, buyer_budget) VALUES ('$userID', '$name', '$buyer_budget')";
      $result = mysqli_query($conn, $sql);
